# SatelliteSimJulia 测试入口（低成本、对齐活跃 API）
#
# 遗留巨型测试套件见 test/runtests_legacy.jl（需 SATSIM_RUN_LEGACY=1 手动运行）。
...
include(joinpath(@__DIR__, "test_pinn_routing.jl"))
include(joinpath(@__DIR__, "test_time_grid_alignment.jl"))
include(joinpath(@__DIR__, "test_distributed.jl"))
include(joinpath(@__DIR__, "test_handover_access.jl"))
include(joinpath(@__DIR__, "test_soft_selection.jl"))
include(joinpath(@__DIR__, "test_weather_smoke.jl"))
include(joinpath(@__DIR__, "test_pinn_train_infer.jl"))
include(joinpath(@__DIR__, "test_coordinator_integration.jl"))
include(joinpath(@__DIR__, "test_distributed_multiprocess.jl"))
include(joinpath(@__DIR__, "test_earth_fixed_longitude.jl"))
include(joinpath(@__DIR__, "test_minload_loads.jl"))
include(joinpath(@__DIR__, "test_cache_validation.jl"))
