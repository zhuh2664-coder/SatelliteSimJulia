...
# export geodetic_to_ecef_km, ecef_to_geodetic_lla, ecef_to_ned_vector,
#        distance_km, elevation_deg, has_los, propagation_delay_ms,
#        compute_rtn_coordinates, compute_azimuth_from_rtn,
#        compute_elevation_from_rtn  # 收窄：无下游消费者
